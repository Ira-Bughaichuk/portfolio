...
export default function SubCart(item: ISubCartProps) {
  return (
    ...
    bg-color-btn-extra py-[3.5px] px-[10px] mm:py-[6px] mm:px-4 xl:py-2 xl:px-6 text-color-secondary text-[11px] leading-[16.5px] mm:text-[13px] mm:leading-[19.5px] xl:text-[14px] xl:leading-[16.8px]"
    >
      {item.framework}
    </p>
  );
