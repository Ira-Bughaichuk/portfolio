...
export default function LanguagesCart({
  ...
  return (
    <div className="w-[150px] md:w-[200px] xl:w-[250px] border-[1px] border-solid border-color-primary rounded-[10px] py-4 px-2 md:py-[30px] md:px-[22px] flex flex-col gap-2 md:gap-6 items-center justify-center">
