...
export default function Buttons({title, path, children}: IButtonsProps) {
  return (
    <Link href={path} target='_blank' aria-label={title} rel="noopener noreferrer nofollow" className='font-roboto w-full text-color-accent-primary border-[1px] border-solid border-color-btn-primary 
