...
export default function ProjectSlider(item:IProjectSliderProps) {
  return (
    <div className="relative">
        <p className="absolute z-10 -top-2 left-2 font-condensed border-[1px] border-solid border-color-bg-primary rounded-tl-lg rounded-tr-none rounded-bl-lg rounded-br-lg
        ...
        <div className=" w-[171px] h-[132px] mm:w-[235px] mm:h-[180px] xl:w-[312px] xl:h-[220px] mb-4 rounded-[10px] overflow-hidden">
            ...
            className='width-full height-auto object-cover '/>
        </div>
