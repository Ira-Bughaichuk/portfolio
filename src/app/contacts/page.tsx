  ...
  return (
    ...
    <section className="section">
          <div className="container mx-auto">
              ...
              <Title type='main' title='Place Your Order'/>
              <div className="flex flex-col gap-3 xl:gap-6 mb-5 mm:mb-[30px] xl:mb-[40px]">
                ...
                <p className="text-[15px] font-normal leading-[22.5px] mm:text-lg mm:leading-[27px] xl:text-2xl xl:leading-9">Welcome to my project order form! Please fill out the details below to provide me with information about your project requirements. Lets create something amazing together!</p>
